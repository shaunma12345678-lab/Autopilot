...
// equity, and can request a no-obligation cash offer. Submissions flow to
// Admin → 📥 Inbound Sellers with an instant operator alert. Informational
// only — clearly labeled as not legal or financial advice.
...
function OfferForm() {
  const [form, setForm] = useState({ name: "", phone: "", email: "", address: "", city: "", state: "", zip: "", timeframe: "", owed: "", situation: "", website: "" })
  ...
  return (
    <div id="offer" className="bg-gray-900/70 border border-emerald-600/30 rounded-2xl p-6">
      <h3 className="text-lg font-bold text-white">Get a no-obligation cash offer</h3>
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-12">
        ...
        <section>
          ...
          <p className="text-[11px] text-gray-600 mt-2">Timeline shown is typical for California non-judicial foreclosure; other states differ. Check your notices for your exact dates.</p>
        </section>
